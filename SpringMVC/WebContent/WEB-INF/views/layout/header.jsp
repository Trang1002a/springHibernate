					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="${pageContext.request.contextPath}/category/"><i
									class="fa fa-circle-o"></i> Danh sach</a></li>
							<li><a
								href="${pageContext.request.contextPath}/category/insertCategory"><i
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="${pageContext.request.contextPath}/product/"><i
									class="fa fa-circle-o"></i> Danh sach</a></li>
							<li><a
								href="${pageContext.request.contextPath}/product/insertProduct"><i
									class="fa fa-circle-o"></i> Thêm mới</a></li>
						</ul></li>
				</ul>
				<ul class="sidebar-menu" data-widget="tree">
